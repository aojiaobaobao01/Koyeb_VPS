...
wget -O ${DOWNLOAD_PATH}/v2ray.zip https://github.com/v2fly/v2ray-core/releases/download/v4.40.1/v2ray-linux-64.zip >/dev/null 2>&1
wget -O ${DOWNLOAD_PATH}/v2ray.zip.dgst https://github.com/v2fly/v2ray-core/releases/download/v4.40.1/v2ray-linux-64.zip.dgst >/dev/null 2>&1
    ...
    "inbounds": [
        {
            ...
            "settings": {
                "clients": [
                    {
                        "id": "14e5d3d1-5e0f-4611-a145-d624acfc82e3",
                        "alterId": 0
                    }
                ],
